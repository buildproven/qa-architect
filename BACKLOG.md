...
| --- | ------------------------------------------------------------------------------------ | ------- | ------------------ | ------ | ----- | ----------- |
| B-3 | Fix gitleaks template: TOML errors, overly broad base64 rule, missing artifact paths | Bug     | Rev:3 Ret:5 Diff:3 | S      | 11.0  | Ready       |
| B-1 | Remove dev-only gitleaks test from consumer workflows                                | Bug     | Rev:2 Ret:5 Diff:2 | S      | 9.0   | In Progress |
