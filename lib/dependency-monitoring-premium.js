 ...
 *
 * @param {Object|null} [framework] - Detected framework metadata
 * @returns {Object} Dependabot groups configuration
 */
function generateReactGroups(framework = null) {
  void framework
  const groups = {}
 ...
 * @returns {Object} Dependabot groups configuration
 */
function generateVueGroups(framework = null) {
  void framework
  const groups = {}
 ...
 * @returns {Object} Dependabot groups configuration
 */
function generateAngularGroups(framework = null) {
  void framework
  const groups = {}
 ...
 * @returns {Object} Dependabot groups configuration
 */
function generateTestingGroups(framework = null) {
  void framework
  const groups = {}
 ...
 * @returns {Object} Dependabot groups configuration
 */
function generateBuildToolGroups(framework = null) {
  void framework
  const groups = {}
 ...
 * @returns {Object} Dependabot groups configuration
 */
function generateStorybookGroups(framework = null) {
  void framework
  const groups = {}
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateDjangoGroups(framework = null) {
  void framework
  return {
    'django-core': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateFastAPIGroups(framework = null) {
  void framework
  return {
    'fastapi-core': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateFlaskGroups(framework = null) {
  void framework
  return {
    'flask-core': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateDataScienceGroups(framework = null) {
  void framework
  return {
    'data-core': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generatePythonTestingGroups(framework = null) {
  void framework
  return {
    'testing-frameworks': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateActixGroups(framework = null) {
  void framework
  return {
    'actix-core': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateAsyncRuntimeGroups(framework = null) {
  void framework
  return {
    'async-runtime': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateSerdeGroups(framework = null) {
  void framework
  return {
    'serde-ecosystem': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateRailsGroups(framework = null) {
  void framework
  return {
    'rails-core': {
 ...
 * @param {Object|null} [framework] - Detected framework metadata
 */
function generateRSpecGroups(framework = null) {
  void framework
  return {
    'testing-frameworks': {
