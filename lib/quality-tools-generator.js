 ...
 * @param {{maxFCP?:number, maxLCP?:number, maxCLS?:number, maxTBT?:number, performance?:number, accessibility?:number, bestPractices?:number, seo?:number}|null} [options.budgets] - Optional Lighthouse budgets
 ...
 * @param {{maxJs?:string, maxCss?:string}|null} [options.budgets] - Optional bundle budgets
